...
export default function SignupPage() {
  ...
  const isClerkReady = !!signUp && fetchStatus === 'idle';
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="w-full max-w-[420px] px-6 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="glass-panel p-8 md:p-10 animate-fade-in" style={{ animationDelay: '100ms' }}>
          ...
          >
            {googleLoading ? (
              <div className="w-5 h-5 border-2 border-slate-300 border-t-accent-500 rounded-full animate-spin" />
            ) : (
              <GoogleIcon />
            )}
